...
$(function() {
    ...
    $('body').on('click', '.js_delete-page, .js_delete-group, .js_delete-event, .js_delete-template, .js_delete-profile-template', function (e) {
        e.preventDefault();
        var id = $(this).data('id');
        if($(this).hasClass('js_delete-page')) {
            var handle = 'page';
        } else if($(this).hasClass('js_delete-template')) {
            var handle = 'page-template';
        } else if($(this).hasClass('js_delete-profile-template')) {
            var handle = 'profile-template';
