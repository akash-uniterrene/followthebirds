...
(function($, _) {
    ...
    */
    ...
    SirTrevor.Blocks.Columns = (function() {
        return SirTrevor.Block.extend({
            ...
            beforeBlockRender: function() {
                this.controls = {
					'onecolumns': this.changeColumnsHandler('columns-12'),
            ...
            _setBlockInner: function() {
                ...
                this.applyColumns('columns-12', true); /* default */
            },
  ...
  */
    SirTrevor.Blocks.Heading = SirTrevor.Block.extend({
        ...
        editorHTML: '<div class="heading-block"><select name="heading" class="form-control"><option value="h1">H1</option><option value="h2">H2</option><option value="h3">H3</option><option value="h4">H4</option><option value="h5">H5</option><option value="h6">H6</option></select></div><div class="st-required st-text-block st-text-block--heading" contenteditable="true"></div>',
  ...
  /*
    Phofile Photo
  */
    SirTrevor.Blocks.Profile = SirTrevor.Block.extend({
        type: 'Profile',
    ...
    About Me
    */
    SirTrevor.Blocks.About = SirTrevor.Block.extend({
        type: 'About',
    ...
    Friends
    */
    SirTrevor.Blocks.Friends = SirTrevor.Block.extend({
        type: 'Friends',
    ...
    Pages
    */
    SirTrevor.Blocks.Pages = SirTrevor.Block.extend({
        type: 'Pages',
    ...
    Groups
    */
    SirTrevor.Blocks.Groups = SirTrevor.Block.extend({
        type: 'Groups',
    ...
    Phofile Cover
    */
    SirTrevor.Blocks.Cover = SirTrevor.Block.extend({
        type: 'Cover',
  ...
  /*
    Phofile Posts
  */
    SirTrevor.Blocks.Post = SirTrevor.Block.extend({
        type: 'Post',
	...
	/* Profile Photos */
		SirTrevor.Blocks.Photo = SirTrevor.Block.extend({
			...
			loadData: function(data) {
				console.log(data);
				this.getTextBlock().html(SirTrevor.toHTML(data.text, this.type));
				this.$('[name=photo]').val(data.photo);
			}
		});
    /*
      Simple Image Block
