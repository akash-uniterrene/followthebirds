...
/settings/profile" class="btn btn-default">
			...
			<?php if ($_smarty_tpl->tpl_vars['view']->value == '') {?>
				...
				<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['profile']->value['jsonArray']['data'], 'block');
if ($_from !== null) {
...
/followers"><?php echo $_smarty_tpl->tpl_vars['profile']->value['followers_count'];?>
 <?php echo __("people");?>
											...
											<!-- about -->
									 <?php } elseif ($_smarty_tpl->tpl_vars['block']->value['type'] == 'pages') {?>
										<!-- pages -->
										<?php if (count($_smarty_tpl->tpl_vars['profile']->value['pages']) > 0) {?>
...
?>
										...
										<?php }?>
										<!-- pages -->									
									<?php } elseif ($_smarty_tpl->tpl_vars['block']->value['type'] == 'groups') {?>
										<!-- groups -->
										<?php if (count($_smarty_tpl->tpl_vars['profile']->value['groups']) > 0) {?>
											<div class="panel panel-default panel-friends">
												<div class="panel-heading">
...
?>
										...
										<?php }?>
										<!-- groups -->
									 <?php } elseif ($_smarty_tpl->tpl_vars['block']->value['type'] == 'friends') {?>
										<!-- friends -->
										<?php if ($_smarty_tpl->tpl_vars['profile']->value['friends_count'] > 0) {?>
											<div class="panel panel-default panel-friends">
												<div class="panel-heading">
...
?>
									 ...
									 <?php } elseif ($_smarty_tpl->tpl_vars['block']->value['type'] == 'post') {?>
										...
										<?php if ($_smarty_tpl->tpl_vars['user']->value->_logged_in) {?>
											<?php if ($_smarty_tpl->tpl_vars['user']->value->_data['user_id'] == $_smarty_tpl->tpl_vars['profile']->value['user_id']) {?>
												<?php $_smarty_tpl->_subTemplateRender('file:_publisher.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('_handle'=>"me",'_privacy'=>true), 0, true);
?>
...
?>
										...
										<!-- posts -->
										<?php $_smarty_tpl->_subTemplateRender('file:_posts.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('_get'=>"posts_profile",'_id'=>$_smarty_tpl->tpl_vars['profile']->value['user_id']), 0, true);
?>
								 	 ...
								 	 <?php } elseif ($_smarty_tpl->tpl_vars['block']->value['type'] == 'profile') {?>								
										...
										<div class="panel panel-default" style="overflow:hidden">
											<img style="margin:auto;"<?php if ($_smarty_tpl->tpl_vars['profile']->value['user_picture_id']) {?> class="js_lightbox" data-id="<?php echo $_smarty_tpl->tpl_vars['profile']->value['user_picture_id'];?>
...
">
											<?php if ($_smarty_tpl->tpl_vars['profile']->value['user_id'] == $_smarty_tpl->tpl_vars['user']->value->_data['user_id']) {?>
												...
												<div class="<?php if ($_smarty_tpl->tpl_vars['profile']->value['user_picture_default']) {?>x-hidden<?php }?>">
