...
<div class="container mt20 offcanvas">
    <div class="row">
	<?php if ($_smarty_tpl->tpl_vars['view']->value == "create-template") {?>
		<?php $_smarty_tpl->_subTemplateRender('file:profile-template-customize.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>

	<?php } elseif ($_smarty_tpl->tpl_vars['case']->value == "edit-template") {?>
		<?php $_smarty_tpl->_subTemplateRender('file:profile-template-customize.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
...
/settings"><i class="fa fa-cog fa-fw fa-lg pr10"></i> <?php echo __("Account Settings");?>
						...
						<li <?php if ($_smarty_tpl->tpl_vars['view']->value == "templates") {?>class="active"<?php }?>>
                            <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/settings/templates"><i class="fa fa-cog fa-clipboard fa-lg pr10"></i> <?php echo __("Template Settings");?>
</a>
                        </li>
...
?>
				...
				<?php } elseif ($_smarty_tpl->tpl_vars['case']->value == "delete-template") {?>
					<div class="panel-heading with-icon">
                        <!-- panel title -->
                        <i class="fa fa-lock pr5 panel-icon"></i>
                        <strong><?php echo __("Delete Settings");?>
</strong>
                        <!-- panel title -->
                    </div>
                    ...
                    <div class="panel-body">
						...
						<div class="text-center">
							<button class="btn btn-danger js_delete-profile-template" data-id="<?php echo $_smarty_tpl->tpl_vars['template']->value['template_id'];?>
">
								<i class="fa fa-trash mr5"></i><?php echo __("Delete Template");?>
				...
				<?php } elseif ($_smarty_tpl->tpl_vars['view']->value == "templates") {?>
					<div class="panel-heading with-icon">
                        <!-- panel title -->
                        <i class="fa fa-lock pr5 panel-icon"></i>
                        <strong><?php echo __("Template Settings");?>
</strong>
                        <!-- panel title -->
...
/settings/create-template">
								...
								<span class="hidden-xs">Create Template</span>
							</a>
						</div>
                    </div>
...
?>
										<tr>
											...
											<td>
										<a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/settings/edit_template-<?php echo $_smarty_tpl->tpl_vars['template']->value['template_id'];?>
">Edit</a>
												|
									    <a href="<?php echo $_smarty_tpl->tpl_vars['system']->value['system_url'];?>
/settings/delete_template-<?php echo $_smarty_tpl->tpl_vars['template']->value['template_id'];?>
">Delete</a>
											</td>
										</tr>
									<?php
