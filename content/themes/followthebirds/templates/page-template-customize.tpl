		...
		<div class="col-md-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form class="js_ajax-forms" data-url="pages_groups_events/create.php?type=page-template&do={if $case == 'create'}create{else}edit{/if}&id={$spage.page_id}" id="contentForm" method="post" accept-charset="utf-8">
						<textarea name="content" cols="40" rows="10" id="content" class="js-st-instance">{$spage.view_template.template_content}</textarea>
							<input type="hidden" name="page_id" value="{$spage.page_id}" /> 
						{if $case == 'edit'}
							<input type="hidden" name="template_id" value="{$spage.view_template.template_id}" />
						{/if}	
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<div class="form-group">
										...
										<div class="controls">
										<input name="pageTitle" value="{$spage.view_template.pageTitle}" id="pageTitle" class="form-control" type="text">
										</div> <!-- /controls -->
									</div>
									<div class="form-group">
