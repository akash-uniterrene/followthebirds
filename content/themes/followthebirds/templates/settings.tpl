...
<div class="container mt20 offcanvas">
	...
	{if $view == "create-template"}
		{include file='profile-template-customize.tpl'}
	{elseif $case == "edit-template"}
		{include file='profile-template-customize.tpl'}
	{else}	
        <!-- left panel -->
            ...
            <div class="panel panel-default">
                <div class="panel-body with-nav">
                    <ul class="side-nav">
						...
						<li {if $view == "templates"}class="active"{/if}>
                            <a href="{$system['system_url']}/settings/templates"><i class="fa fa-cog fa-clipboard fa-lg pr10"></i> {__("Template Settings")}</a>
                        </li>
        ...
        <div class="col-sm-9 offcanvas-mainbar">
            <div class="panel panel-default">
				...
				{elseif $case == "delete-template"}
					<div class="panel-heading with-icon">
                        <!-- panel title -->
                        <i class="fa fa-lock pr5 panel-icon"></i>
                        <strong>{__("Delete Settings")}</strong>
                        <!-- panel title -->
                    </div>
                    ...
                    <div class="panel-body">
						...
						<div class="text-center">
							<button class="btn btn-danger js_delete-profile-template" data-id="{$template.template_id}">
				...
				{elseif $view == "templates"}
					<div class="panel-heading with-icon">
                        <!-- panel title -->
                        <i class="fa fa-lock pr5 panel-icon"></i>
                        <strong>{__("Template Settings")}</strong>
                        <!-- panel title -->
						<div class="mt10 pull-right flip">
							<a class="btn btn-success btn-sm" href="{$system['system_url']}/settings/create-template">
								...
								<table class="table">
									...
									{foreach $templates as $template}
										<tr>
											...
											<td>
										<a href="{$system['system_url']}/settings/edit_template-{$template.template_id}">Edit</a>
												|
									    <a href="{$system['system_url']}/settings/delete_template-{$template.template_id}">Delete</a>
											</td>
										</tr>
									{/foreach}
									</tbody>	
